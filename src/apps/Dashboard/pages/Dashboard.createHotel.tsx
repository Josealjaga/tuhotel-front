...
type CreateHotelProps = object;

const CreateHotel: FC<CreateHotelProps> = () => {
  ...
  const onSubmit = async (data: Hotel) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/admin/hotels`, { 
        method: 'POST',
        headers: {
      ...
      snackbarRef.current = enqueueSnackbar('Hotel creado exitosamente');
